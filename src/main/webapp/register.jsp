...
<div class="container">
    ...
    <form action="auth?action=doRegister" method="post" autocomplete="off">
       <label>Enter name:</label>
       <input type="text" name="name"
       pattern="^[A-Za-z ]{2,50}$"
       title="Name should contain only letters and spaces (2-50 characters)" required autocomplete="off">

       <label>Enter username:</label>
       <input type="text" name="username"
       pattern="^[a-zA-Z0-9._%+-]+@[a-zA-Z0-9.-]+\.[A-Za-z]{2,}$"
       title="Enter a valid username e.g-omghodekar13@gmail.com" required autocomplete="off">
